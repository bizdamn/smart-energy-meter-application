...
export default function DevicePage({ command01, command02, command04, organisation, device }) {
    ...
    async function monthlyChartDataFilter() {
        closeSnackbar()
        try {
            const { data } = await axios.post(`${process.env.NEXT_PUBLIC_Chart_API_Python_Link}/three-phase`, {
                start_date: startDate,
                ...
                <Grid item lg={2} xs={6}>
                    <List>
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#total-cost">
                                <ListItemText
                                    primary={`: ${parseFloat(command01[0]?.eb * (organisation[0].perUnitCost)).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                        <Divider />
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#kwh">
                                <ListItemText
                                    primary={`: ${parseFloat(command01[0]?.eb).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                        <Divider />
                        ...
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#kva">
                                <ListItemText
                                    primary={`: ${parseFloat(command04[0]?.kVA_Load_red).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                        <Divider />
                        ...
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#kvar">
                                <ListItemText
                                    primary={`: ${parseFloat(command04[0]?.kVAR_Load_red).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                        <Divider />
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#kw">
                                <ListItemText
                                    primary={`: ${parseFloat(command04[0]?.kW_Load_red).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                        <Divider />
                ...
                <Grid item lg={2} xs={6}>
                    <List>
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#power-factor">
                                <ListItemText
                                    primary={`: ${parseFloat(command02[0]?.power_factor).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                        ...
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#frequency">
                                <ListItemText
                                    primary={`: ${parseFloat(command02[0]?.frequency).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                        <Divider />
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#voltage">
                                <ListItemText
                                    primary={`: ${parseFloat(command02[0]?.voltage_red).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                        <Divider />
                        ...
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#current">
                                <ListItemText
                                    primary={`: ${parseFloat(command02[0]?.current_red).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                        ...
                        <ListItem style={{ backgroundColor: "#EEEEEE" }}>
                            <ListItemButton component="a" href="#dg">
                                <ListItemText
                                    primary={`: ${parseFloat(command01[0]?.dg).toFixed(2)}`}
                                />
                            </ListItemButton>
                        </ListItem>
                    </List>
                </Grid>
                <Grid item  style={{ paddingTop: '1rem' }} lg={4} xs={12}>
